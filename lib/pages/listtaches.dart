...
class Mestaches extends StatefulWidget {
  Mestaches({Key key, this.title}) : super(key: key);
  final String title;
...
class _MestachesState extends State<Mestaches> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Toutes mes tâches"),
          centerTitle: true,
          elevation: 0,
                ...
                return Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 20,),
                      Text("Oups! vous n'avez ajouté aucune tâche", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)
                    ],
                  ),
                );
              }else{
